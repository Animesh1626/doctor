  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
      <div className="relative h-48 bg-gray-200">
        <img src={doctor.image || "/placeholder.svg"} alt={doctor.name} fill="true" className="w-full h-48 object-cover" />
      </div>
      <div className="p-5">
        <h3 className="font-bold text-lg text-gray-900">Dr.{doctor.name} {doctor.lastName}</h3>
        <p className="text-blue-600 mb-2">{doctor.specialization}</p>
        <p className="text-gray-500 mb-1">{doctor.degree}</p>
